...
urlpatterns = [
    ...
    path('company_settings/admin_settings', views.admin_settings, name='admin_settings'),
    path('company_settings/admin_settings/master_admin2', views.master_admin2, name='master_admin2'),
]